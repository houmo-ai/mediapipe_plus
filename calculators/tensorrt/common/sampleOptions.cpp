...
// clang-format off
    os << "=== Build Options ==="                                                                                                            << std::endl <<
          ...
          "  --explicitBatch             Use explicit batch dimension when building the engine (default = explicit if ONNX model is used "   << std::endl <<
          "                              or if dynamic shapes are provided. Otherwise, default = implicit.)"                                 << std::endl <<
          ...
          "  --safe                      Enable build safety certified engine"                                                               << std::endl <<
          "  --restricted                Enable safety scope checking with kSAFETY_SCOPE build flag"                                         << std::endl <<
