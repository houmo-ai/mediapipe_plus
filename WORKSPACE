...
git_repository(
    name =  "mediapipe_official",
    remote = "https://github.com/google/mediapipe.git",
    commit = "137e1cc7630524ea1c3a9b120985285fe43c8a3f",
    patches = [
	"//patch_houmo:change_repo_url.diff"
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    patches = [
        "@mediapipe_official//third_party:com_google_absl_f863b622fe13612433fdf43f76547d5edda0c93001.diff"
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    build_file = "@mediapipe_official//third_party:benchmark.BUILD",
)
...
http_archive(
    ...
    strip_prefix = "glog-0a2e5931bd5ff22fd3bf8999eb8ce776f159cda6",
    sha256 = "58c9b3b6aaa4dd8b836c0fd8f65d0f941441fb95e27212c5eeb9979cfd3592ab",
    build_file = "@mediapipe_official//third_party:glog_no_gflags.BUILD",
    urls = [
        "https://github.com/google/glog/archive/0a2e5931bd5ff22fd3bf8999eb8ce776f159cda6.zip",
    ],
    patches = [
        "@mediapipe_official//third_party:com_github_glog_glog_9779e5ea6ef59562b030248947f787d1256132ae.diff",
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    build_file = "@mediapipe_official//third_party:easyexif.BUILD",
)
...
http_archive(
    ...
    build_file = "@mediapipe_official//third_party:libyuv.BUILD",
)
...
http_archive(
    ...
    urls = ["https://github.com/protocolbuffers/protobuf/archive/v3.11.4.tar.gz"],
    patches = [
        "@mediapipe_official//third_party:com_google_protobuf_fixes.diff"
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    patches = [
        "@mediapipe_official//third_party:ceres_solver_compatibility_fixes.diff"
    ],
    patch_args = [
        "-p1",
    ],
...
new_local_repository(
    name = "linux_opencv",
    build_file = "@mediapipe_official//third_party:opencv_linux.BUILD",
    path = "/usr",
)

new_local_repository(
    name = "linux_ffmpeg",
    build_file = "@mediapipe_official//third_party:ffmpeg_linux.BUILD",
    path = "/usr"
)

new_local_repository(
    name = "macos_opencv",
    build_file = "@mediapipe_official//third_party:opencv_macos.BUILD",
    path = "/usr/local/opt/opencv@3",
)

new_local_repository(
    name = "macos_ffmpeg",
    build_file = "@mediapipe_official//third_party:ffmpeg_macos.BUILD",
    path = "/usr/local/opt/ffmpeg",
)

new_local_repository(
    name = "windows_opencv",
    build_file = "@mediapipe_official//third_party:opencv_windows.BUILD",
    path = "C:\\opencv\\build",
)

http_archive(
    name = "android_opencv",
    build_file = "@mediapipe_official//third_party:opencv_android.BUILD",
...
http_archive(
    ...
    build_file = "@mediapipe_official//third_party:opencv_ios.BUILD",
    type = "zip",
...
http_archive(
    ...
    build_file = "@mediapipe_official//third_party:stblib.BUILD",
    patches = [
        "@mediapipe_official//third_party:stb_image_impl.diff"
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    patches = [
        ...
        "@mediapipe_official//third_party:build_bazel_rules_apple_bypass_test_runner_check.diff"
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    build_file = "@mediapipe_official//third_party:google_toolbox_for_mac.BUILD",
)
...
http_archive(
    ...
    patches = [
        "@mediapipe_official//third_party:org_tensorflow_compatibility_fixes.diff",
        "@mediapipe_official//third_party:org_tensorflow_objc_cxx17.diff",
        "@mediapipe_official//third_party:org_tensorflow_host_aarch64_fixes.diff",
    ],
    patch_args = [
        "-p1",
    ],
